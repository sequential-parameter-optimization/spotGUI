...
def test_get_scenario_dict_river(
    ...
    get_classification_metric_sklearn_levels_mock,
    get_river_binary_classification_datasets_mock,
    get_river_regression_core_model_names_mock,
    get_regression_metric_sklearn_levels_mock,
    get_river_rules_core_model_names_mock,
    get_river_regression_datasets_mock,
    get_river_prep_models_mock,
